    ...
    <nav class="l-nav">
        <div class="nav_list">
            <div class="list-group btn-group-vertical">
                <a class="nav_link ${ fn:contains(paginaCorrente, 'perfil') ? 'active-navbar' : ''}" id="paginaPerfil" type="button" href="/emug/cliente/perfil.jsp">
                ...
                <a class="nav_link ${ fn:contains(paginaCorrente, 'compras') ? 'active-navbar' : ''}" id="paginaEstoque" type="button" href="/emug/cliente/compras.jsp">
                    <span class="material-icons inline-icon">shopping_bag</span> Compras
                </a>

                <a class="nav_link ${ fn:contains(paginaCorrente, 'enderecos') ? 'active-navbar' : ''}" id="paginaClientes" type="button" href="/emug/cliente/enderecos.jsp">
